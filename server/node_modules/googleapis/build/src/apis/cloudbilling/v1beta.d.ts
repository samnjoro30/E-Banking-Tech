...
export declare namespace cloudbilling_v1beta {
    ...
    export class Resource$Billingaccounts {
         ...
         */
        estimateCostScenario(params: Params$Resource$Billingaccounts$Estimatecostscenario, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        estimateCostScenario(params?: Params$Resource$Billingaccounts$Estimatecostscenario, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EstimateCostScenarioForBillingAccountResponse>>;
    ...
    export class Resource$V1beta {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        estimateCostScenario(params: Params$Resource$V1beta$Estimatecostscenario, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        estimateCostScenario(params?: Params$Resource$V1beta$Estimatecostscenario, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$EstimateCostScenarioWithListPriceResponse>>;
