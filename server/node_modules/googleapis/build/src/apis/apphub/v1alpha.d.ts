...
export declare namespace apphub_v1alpha {
    ...
    export class Resource$Projects$Locations {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getPerimeter(params: Params$Resource$Projects$Locations$Getperimeter, options: StreamMethodOptions): Promise<GaxiosResponseWithHTTP2<Readable>>;
        getPerimeter(params?: Params$Resource$Projects$Locations$Getperimeter, options?: MethodOptions): Promise<GaxiosResponseWithHTTP2<Schema$Perimeter>>;
        getPerimeter(params: Params$Resource$Projects$Locations$Getperimeter, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        getPerimeter(params: Params$Resource$Projects$Locations$Getperimeter, options: MethodOptions | BodyResponseCallback<Schema$Perimeter>, callback: BodyResponseCallback<Schema$Perimeter>): void;
        getPerimeter(params: Params$Resource$Projects$Locations$Getperimeter, callback: BodyResponseCallback<Schema$Perimeter>): void;
    ...
    export interface Params$Resource$Projects$Locations$Getperimeter extends StandardParameters {
        /**
         * Required. Fully qualified name of the Perimeter Expected format: `projects/{project\}/locations/{location\}/perimeter`.
         */
        name?: string;
