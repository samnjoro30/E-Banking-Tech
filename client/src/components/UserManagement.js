...
const UserManagement = () => {
    ...
    const fetchUsers = async () => {
      ...
      try {
        ...
        const res = await axios.get(
          'https://e-banking-tech.onrender.com/api/admin/users',
          {
  ...
  const handleEditUser = async userId => {
    ...
    try {
      await axios.put(
        `https://e-banking-tech.onrender.com/api/admin/users/${userId}`,
        editUserData,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleDeactivateUser = async userId => {
    ...
    try {
      await axios.post(
        `https://e-banking-tech.onrender.com/api/admin/deactivate-user/${userId}`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
